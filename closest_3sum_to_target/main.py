...
def main() -> None:
    ...
    assert validates(expt1, res1) == True, "failure in handing 3 elements"
    ...
    assert validates(expt3, res3) == True, "failure in handing closest match"

    nums4, target4 = [1, 2, 3, -1, 8, -1, 19], 6
    expt4 = [[1, 2, 3], [-1, -1, 8]]
    res4 = finds_triplets(nums4, target4)
    
    assert validates(expt4, res4) == True, "failure in handing 3 elements"
